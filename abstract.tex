...
%
Commonly, linear models such as a double integrator with an inertia gain are employed to describe the relationship between torque and position of the ISP joints.
%
...
for both stabilization and orientation tracking for a 3-DOF ISP.
%such as a vehicle.
%
Full state feedback and output feedback cases are considered.
%
...
%
The inner controller ideally rejects the \textit{dynamic} disturbances acting on the ISP joints, reducing the system to an ideal double integrator. 
%
...
Numerical simulations show the efficiency and performance of the proposed controller and observer.
